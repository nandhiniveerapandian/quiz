  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <center><button type="button" class="btn btn-primary"  data-toggle="tab" href="#select">Start QUIZ</button></center>
	   ...
	   <div class="col-sm-4">
	   <br><br><div id="select" class="tab-pane fade">
	   <form method="post" action="que_show.php">
	  ...
	  <br><br><center><input type="submit" value="submit" class="btn btn-primary"/><center>
	  </form>
	  </div>
	  </div>
	  <div class="col-sm-4"></div>
